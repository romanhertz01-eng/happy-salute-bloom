...
const STEPS = [
  {
    ...
    title: "38 кандидатов",
    description:
      "Собрали все сервисы виртуальных карт для россиян из топов поиска и Telegram-чатов.",
    icon: null,
  },
  {
    n: 2,
    title: "Документы",
    description:
      "Проверили лицензии банков-партнёров через регистры ЦБ Армении, Казахстана, Турции, Грузии.",
    icon: FileText,
  },
  {
    n: 3,
    title: "Личные тесты",
    description:
      "Оформили финалистов, сделали 142 платежа: ChatGPT, Netflix, Steam, Booking, Adobe. Своими ₽86 000.",
    icon: FlaskConical,
  },
  {
    n: 4,
    title: "4 800 отзывов",
    description:
      "Telegram-чаты, banki.ru, Otzovik, IRecommend, ветки на Хабре и vc.ru.",
    icon: MessageSquare,
  },
  {
    n: 5,
    title: "Свели в формулу",
    description:
      "Пять весов, балл 0–5. Пересчёт раз в месяц с учётом изменений тарифов.",
    icon: Calculator,
  },
];

const WEIGHTS = [
  { label: "Надёжность сервиса и лицензия банка", value: 30 },
    ...
    <section className="border-b border-border bg-background">
      <div className="mx-auto max-w-[1240px] px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
        ...
        <h2 className="max-w-3xl font-serif text-3xl font-bold tracking-tight text-primary sm:text-4xl lg:text-[42px] lg:leading-[1.15]">
          Как мы строим рейтинг 2026
        </h2>
        <p className="mt-4 max-w-2xl text-sm text-muted-foreground sm:text-base">
          Не «по личным ощущениям». Формализованные веса, реальные тесты, публичные источники. Пересчитываем раз в месяц.
        </p>
